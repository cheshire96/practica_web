...
<div class="panel panel-default">
	<div class="panel-body">
		<form role="form" method="post" action="../class/modificacion_cliente.php">
			<fieldset> <legend>Editar Cliente</legend>
				<input type="hidden" value="<?php echo $this->valores['id']; ?>" name="id"/>
				...
				<button type="submit" name="cont" value=1 class="btn btn-info">Actualizar</button>
			</fieldset>
		</form>
	</div>
</div>
